...
exports.createInvoiceDB = async (subtotal, taxTotal, serviceChargeTotal, total, date, selectedPaymentType, tenantId, username = null) => {
  const conn = await getMySqlPromiseConnection();
  try {
    ...
    await conn.query(sql, [invoiceId, subtotal, taxTotal, serviceChargeTotal, total, date, selectedPaymentType, tenantId, username]);
